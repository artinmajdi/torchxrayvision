...
def get_data(dataset_str, masks=False, unique_patients=False,
    ...
    if "covid" in dataset_str:
        dataset = xrv.datasets.COVID19_Dataset(
            imgpath=f"{dataset_dir}/covid-chestxray-dataset/images",
            csvpath=f"{dataset_dir}/covid-chestxray-dataset/metadata.csv",
            transform=transform,
            data_aug=data_aug,
    ...
    if "pc" in dataset_str:
        dataset = xrv.datasets.PC_Dataset(
            imgpath=f"{dataset_dir}/images-512-PC",
            transform=transform,
            data_aug=data_aug,
    ...
    if "rsna" in dataset_str:
        dataset = xrv.datasets.RSNA_Pneumonia_Dataset(
            imgpath=f"{dataset_dir}/kaggle-pneumonia-jpg/stage_2_train_images_jpg",
            transform=transform,
            data_aug=data_aug,
            unique_patients=unique_patients,
    ...
    if "nih" in dataset_str:
        dataset = xrv.datasets.NIH_Dataset(
            imgpath=f"{dataset_dir}/images-512-NIH",
            transform=transform,
            data_aug=data_aug,
            unique_patients=unique_patients,
            pathology_masks=masks,
    ...
    if "siim" in dataset_str: 
        dataset = xrv.datasets.SIIM_Pneumothorax_Dataset(
            imgpath=f"{dataset_dir}SIIM_TRAIN_TEST/dicom-images-train/",
            csvpath=f"{dataset_dir}SIIM_TRAIN_TEST/train-rle.csv",
            transform=transform,
            data_aug=data_aug,
            unique_patients=unique_patients,
            pathology_masks=masks,
    ...
    if "chex" in dataset_str:
        dataset = xrv.datasets.CheX_Dataset(
            imgpath=f"{dataset_dir}/CheXpert-v1.0-small",
            csvpath=f"{dataset_dir}/CheXpert-v1.0-small/train.csv",
            transform=transform,
            data_aug=data_aug,
    ...
    if "mimic_ch" in dataset_str:
        dataset = xrv.datasets.MIMIC_Dataset(
            ...
            csvpath=f"{dataset_dir}/MIMICCXR-2.0/mimic-cxr-2.0.0-chexpert.csv.gz",
            metacsvpath=f"{dataset_dir}/MIMICCXR-2.0/mimic-cxr-2.0.0-metadata.csv.gz",
            transform=transform,
            data_aug=data_aug,
            unique_patients=unique_patients,
            views=views,
    ...
    if "openi" in dataset_str:
        dataset = xrv.datasets.Openi_Dataset(
            imgpath=f"{dataset_dir}/OpenI/images/",
            transform=transform,
            data_aug=data_aug,
            views=views,
        )
    ...
    if "vin" in dataset_str:
        dataset = xrv.datasets.VinBrain_Dataset(
            imgpath=f"{dataset_dir}vinbigdata-chest-xray-abnormalities-detection/train",
            csvpath=f"{dataset_dir}vinbigdata-chest-xray-abnormalities-detection/train.csv",
            pathology_masks=masks,
            transform=transform,
            data_aug=data_aug,
            views=views,
    ...
    if "objectcxr" in dataset_str:
        ...
        dataset = xrv.datasets.ObjectCXR_Dataset(
            imgzippath=f"{dataset_dir}/object-CXR/train.zip",
            csvpath=f"{dataset_dir}/object-CXR/train.csv",
            pathology_masks=masks,
            transform=transform,
            data_aug=data_aug,
        )
...
#             newlabels.remove("Support Devices")
    ...
    return xrv.datasets.Merge_Dataset(datasets)
